...
```{r save figure 8A data, include=FALSE, eval=FALSE, echo=FALSE}
Mono_v_CSP_plot_nrow2$data %>%
  writexl::write_xlsx("/Users/tuantran/Library/CloudStorage/OneDrive-IndianaUniversity/Manuscripts/KSPZV1 Manuscript/JCI Resubmission April 2023/Data for all Plots JCI Resubmission/Figure 8A CSP Ab vs CD14 monocytes.xlsx")

CSP_pos_by_dose_plot_nrow2$data %>%
  writexl::write_xlsx("/Users/tuantran/Library/CloudStorage/OneDrive-IndianaUniversity/Manuscripts/KSPZV1 Manuscript/JCI Resubmission April 2023/Data for all Plots JCI Resubmission/Figure S9A CSP Ab vs CD14 monocytes.xlsx")
```
...
writexl::write_xlsx(lowBTM_splitCSPIgG_Outcome_BoxPlots$data, "/Users/tuantran/Library/CloudStorage/OneDrive-IndianaUniversity/Manuscripts/KSPZV1 Manuscript/JCI Resubmission April 2023/Data for all Plots JCI Resubmission/Figure 8C Module Expression Score by Outcome by low BTM.xlsx")
```
