---
title: "PfSPZ DGE on VRC 312 & VRC 314 Datasets, then combine with BSPZV1 data"
author: "Tuan M. Tran"
...
```{r combine VRC312 VRC314 BSPZV1 camera dat, eval=FALSE, include=FALSE, echo=FALSE}
...
```{r visualize camera data, echo=FALSE, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE}
### Visualize Camera data as bubble plot

#This was not included in the manuscript but presented here. Filter based on FDR<10% across ≥2 studies.

#Red: enriched in protected/uninfected 
#Blue: enriched in not protected/infected
fdr_threshold <- 0.1

common_pathways <- Cameratab_BSPZV1_VRC312_VRC314 %>%
...
Cameratab_BSPZV1_VRC312_VRC314 <- Cameratab_BSPZV1_VRC312_VRC314 %>%
...
```{r plot camera bubbleplot hi btms, fig.align='center', fig.width=10, fig.height=11, echo=FALSE, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE}
### Plot Camera bubbleplots

#Red: enriched in protected/uninfected 
#Blue: enriched in not protected/infected

#Only modules with FDR<10% in at least 2 studies are shown. KSPZ1 was not included here.
