---
title: "KSPZV1 baseline 1.8x10^6 PfSPZ multimodal ML revised - xgboost nested feature selection and cv on full dataset"
author: "Tuan M. Tran"
...
```{r libraries, include=TRUE, echo=TRUE, eval=FALSE}
library(openxlsx)
library(xgboost)
library(dplyr)
library(tidyverse)
...
```{r read in full dataset, include=FALSE, echo=FALSE, eval=FALSE}
...
```{r read high dose baseline features local, eval=FALSE, echo=FALSE, include=FALSE}
high_dose_features_class <- read_rds(file = paste0(datadir2, "high_dose_baseline_class_features_scaled_imputed.rds"))
```

```{r read high dose baseline features googledrive, eval=FALSE, echo=TRUE, include=TRUE}
...
load(paste0("/Users/tuantran/Library/CloudStorage/OneDrive-IndianaUniversity/Manuscripts/KSPZV1 Manuscript/ML results Tuan/",
           "full_high_dose_baseline_4fold_cv_10_rns/all_folds_data_seed_1943_runs_2500_19_Aug_2023_full.RData"))
```
...
save(fold1, fold2, fold3, fold4,
       file = paste0("/Users/tuantran/Library/CloudStorage/OneDrive-IndianaUniversity/Manuscripts/KSPZV1 Manuscript/ML results Tuan/",
                     "full_high_dose_baseline_4fold_cv_", length(fold4), "_runs/",
