---
title: "KSPZV1 baseline placebo multimodal ML revised - xgboost nested feature selection and cv on full dataset"
author: "Tuan M. Tran"
...
```{r make placebo features, include=FALSE, echo=FALSE, eval=FALSE}
...
```{r read placebo baseline features local, include=FALSE, echo=FALSE, eval=FALSE}
placebo_features_class <- read_rds(file = paste0(datadir2, "placebo_baseline_class_features_scaled_imputed.rds"))
```

```{r read placebo baseline features googledrive, include=TRUE, echo=TRUE, eval=FALSE}
