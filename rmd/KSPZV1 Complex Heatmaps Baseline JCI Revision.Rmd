...
```{r draw to extract clustering info columns, message=FALSE, warning=FALSE, fig.width= 12, fig.height=6, fig.align='center'}
hm <- draw(hm, heatmap_legend_side="bottom", annotation_legend_side="right",
