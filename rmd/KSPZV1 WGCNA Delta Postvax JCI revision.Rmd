...
```
```{r prepare heatmap wgcna limma, fig.align='center', fig.height=5, fig.width=7, include=FALSE, echo=FALSE, eval=FALSE}
...
```{r draw hm, fig.align='center', fig.width=4, fig.height=4, include=FALSE, echo=FALSE, eval=FALSE}
draw(my_hm)
```
...
#### Figure S6 of revised manuscript

```{r plot all_beeswarm_plot, fig.align='center', fig.height=6, fig.width=2, include=FALSE, eval=FALSE, echo=FALSE}
all_beeswarm_plot
```

```{r save scatter pltos and beeswarm arrange, fig.align='center', fig.height=12, fig.width=12}
...
my_hm + my_limma_hm
```
```{r save combined heatmaps, fig.align='center', fig.width=5, fig.height=4}
...
```{r plot networkd graph jci revision, message=FALSE, warning=FALSE, fig.align='center', fig.width=8, fig.height=8, echo=FALSE}
plot(graph)
```
...
### FGSEA on WGCNA Results, JCI revision
...
### Plot WGCNA overrepresentation results, JCI revision
...
### Delta WGCNA Top Modules ORA bar plots (Figure S6B, JCI revision)
