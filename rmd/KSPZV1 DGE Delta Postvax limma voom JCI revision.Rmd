...
Filter based on padj < 0.05. (Requested by reviewer.)
...
```{r plot gsea bubbleplot, fig.align='center', fig.width=6, fig.height=4, echo=FALSE, message=FALSE, warning=FALSE}
...
cairo_pdf(paste0(figdir, "Figure 4G voom version high-dose PfSPZ FDR5.pdf"), width = 6.5, height = 3.75)
...
#local path: "/Volumes/GoogleDrive/My Drive/Tran Lab Shared/Projects/Doris Duke PfSPZ Kenya/PfSPZ Aditi/PfSPZ LDA Analysis/KSPZV1 logCPM expression sets for visualization/PfSPZ_cpm_ExpressionSet_460x23768_allGroups_bothBatches_0_25_for_delta_rmBatchFX_06082021_TMT_logTRUE.rds"
