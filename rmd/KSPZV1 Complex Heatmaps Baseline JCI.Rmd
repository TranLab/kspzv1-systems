---
title: "KSPZV1 Complex Heatmaps Baseline - JCI"
author: "Tuan M. Tran"
date: "11/30/2022"
...
library(fgsea)
library(devtools)
figdir <- "/Users/tuantran/OneDrive - Indiana University/FromGoogle/Manuscripts/KSPZV1 Manuscript/JCI Submission November 2022/Figures for JCI submission/"
```
...
## Print heatmap (Figure 1C)

```{r save heatmap, fig.width= 10, fig.height=7, fig.align="center", eval=FALSE}
#set dimensions
myheight <- 10
mywidth <- 16
cairo_pdf(paste0(figdir, "Fig1C JCI Heatmap", " height", myheight, " width", mywidth, ".pdf"), height = myheight, width = mywidth)
print(hm)
dev.off()
```
...
## Examine SC1 Placebo vs SC1 1.8x10^6 PfSPZ

```{r make sc1 specific barplot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r save make sc1 specific barplot}
...
```{r print GSEA enrichment, message=FALSE, warning=FALSE, fig.width=6, fig.height=4, echo = FALSE, eval = FALSE}
