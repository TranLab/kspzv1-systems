...
```{r readin all_data_btm_for_tte6_correlations, message=FALSE, warning=FALSE}
#from google drive
temp <- tempfile(fileext = ".rds")
dl <- drive_download(
...
```{r save volcano plot dat, include=FALSE, echo=FALSE, eval=FALSE}
writexl::write_xlsx(myPlot$data, path = "/Users/tuantran/Library/CloudStorage/OneDrive-IndianaUniversity/Manuscripts/KSPZV1 Manuscript/JCI Resubmission April 2023/Data for all Plots JCI Resubmission/Figure 3A TTE 6 mos vs flow and CSP IgG features volcano plot.xlsx")
```
...
```{r save TE 6 mos vs MBCs scatter plot dat, include=FALSE, echo=FALSE, eval=FALSE}
writexl::write_xlsx(CSP_MBC_TTE_plot$data, path = "/Users/tuantran/Library/CloudStorage/OneDrive-IndianaUniversity/Manuscripts/KSPZV1 Manuscript/JCI Resubmission April 2023/Data for all Plots JCI Resubmission/Figure 3B TTE 6 mos vs MBCs scatter plot.xlsx")
```
...
```{r print GSEA plot, fig.align='center', fig.height=6, fig.width=6, echo=TRUE}
...
```{r save gsea  CSP MBC plot dat, include=FALSE, echo=FALSE, eval=FALSE}
writexl::write_xlsx(myGSEAClusterPlot$data, path = "/Users/tuantran/Library/CloudStorage/OneDrive-IndianaUniversity/Manuscripts/KSPZV1 Manuscript/JCI Resubmission April 2023/Data for all Plots JCI Resubmission/Figure 3C GSEA CSP MBC correlated genes bar plot.xlsx")
```


```{r save gsea plot CSP MBC, include=FALSE, eval=FALSE, echo=FALSE}
pdf(paste0(figdir, "Figure 3C GSEA CSP MBC barplot JCI Revised.pdf"), width=5, height = 5)
print(addSmallLegend(myGSEAClusterPlot))
dev.off()
```

```{r apply fgsea, warning=FALSE, message=FALSE, include=FALSE, echo=FALSE, eval=FALSE}
...
```{r apply fgsea low-dose PfSPZ, warning=FALSE, message=FALSE, include=FALSE, echo=FALSE, eval=FALSE}
...
```{r apply fgsea mid-dose PfSPZ, warning=FALSE, message=FALSE, include=FALSE, echo=FALSE, eval=FALSE}
...
```{r apply fgsea high-dose PfSPZ, warning=FALSE, message=FALSE, include=FALSE, echo=FALSE, eval=FALSE}
...
```{r collapse all lists into dataframes and bind, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r set options for gsea plots, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r arrange plot TTE GSEA all dose groups, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r plot TTE GSEA all dose groups, fig.align='center', fig.height=10, fig.width=4, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r arrange plot CSP_MBC GSEA all dose groups, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r plot CSP_MBC GSEA all dose groups, fig.align='center', fig.height=9, fig.width=4, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r arrange plot CSP_IgG GSEA all dose groups, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r plot CSP_IgG GSEA all dose groups, fig.align='center', fig.height=16, fig.width=12, echo=FALSE, eval=FALSE, include=FALSE}
all_doses_plot_CSP_IgG
```


```{r arrange plot Vd2 GSEA all dose groups, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r plot Vd2 GSEA all dose groups, fig.align='center', fig.height=16, fig.width=12, echo=FALSE, eval=FALSE, include=FALSE}
all_doses_plot_Vd2
```

```{r arrange data for plots Placebo, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r print GSEA plot Placebo, fig.align='center', fig.height=16, fig.width=12, echo=FALSE, eval=FALSE, include=FALSE}
my_placebo_GSEA_Plot
```

```{r arrange data for plots low-dose PfSPZ, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r print GSEA plot low-dose PfSPZ, fig.align='center', fig.height=12, fig.width=12, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r arrange data for plots mid-dose PfSPZ, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r print GSEA plot mid-dose PfSPZ, fig.align='center', fig.height=12, fig.width=12, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r arrange data for plots high-dose PfSPZ, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r print GSEA plot high-dose PfSPZ, fig.align='center', fig.height=8, fig.width=10, echo=FALSE, eval=FALSE, include=FALSE}
...
```{r print GSEA TTE all doses, fig.align='center', fig.height=9, fig.width=12, echo=FALSE, eval=FALSE, include=FALSE}
